...
public class TestAccountServiceEasyMock {
    private AccountManager mockAccountManager;      // mockAccountManager 相当于数据库

    @BeforeEach
    public void setUp() {
        // 对 AccountManager 进行动态代理
    ...
    public void testTransferOk() {
        ...
        // 预置数据，访问1，返回指定对象 【也就是对代理对象的findAccountForUser方法做实现】
        ...
        accountService.setAccountManager(mockAccountManager);       // 相当于注入service层
        accountService.transfer("1", "2", 50);  // 执行修改操作，一个用户-50，一个用户+50
